...
public class EmployeeResourceIT {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getCapacity()).isEqualTo(DEFAULT_CAPACITY);
        assertThat(testEmployee.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testEmployee.getRefKey()).isEqualTo(DEFAULT_REF_KEY);
    }
    ...
    public void updateEmployee() throws Exception {
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getCapacity()).isEqualTo(UPDATED_CAPACITY);
        assertThat(testEmployee.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testEmployee.getRefKey()).isEqualTo(UPDATED_REF_KEY);
    }
